                ...
                <form method="post">
                    <div className="form">
                        ...
                        <select className="drop" required>
                            ...
                            <option value="Email from Essar">Email from Essar</option>
                        ...
                        <input className="iinput" type="text" name="name" placeholder="Please enter the name of vendor" required/>
                        <br />
                        ...
                        <input className="iinput" type="email" name="E-mail" placeholder="Enter vendor Email"  required/>
                        <br />
                    ...
                    <div className="form-r">
                        <label className="key">
                            ...
                            <br />
                            <input className="iinput" type="text" name="name" placeholder="Please enter your state name" required/>
                            ...
                            <br />
                            <input className="iinput" type="text" name="name" placeholder="City" required/>
                            <br />
                            ...
                            <input className="iinput" type="integer" name="Phonenum" placeholder="+91-1234567890" required/>
                            <br />
